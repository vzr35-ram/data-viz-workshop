...
This was the first artificial satellite. Launched by the Soviet Union, it marked the beginning of the <span style="background: linear-gradient(transparent, cyan)">space age.</span>

### Apollo 11 (1969)

The historic Apollo 11 mission, led by <span class="important">NASA</span>, marked the first successful human landing on the Moon. Astronauts Neil Armstrong and Buzz Aldrin became the first humans to set foot on the lunar surface.
